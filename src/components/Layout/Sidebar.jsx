        ...
        <nav className="flex flex-col gap-1.5 mt-4 px-3 flex-1 relative z-10 overflow-y-auto sidebar-scroll">
          ...
          <div className="px-3">
            <button
              ...
              className="w-full flex items-center justify-between gap-2 px-3 py-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors text-sm"
            ...
            >
              ...
              <span className={`relative inline-flex h-5 w-9 shrink-0 items-center rounded-full transition-colors duration-200 ${tema === 'oscuro' ? 'bg-indigo-400' : 'bg-white/25'}`}>
