          ...
          >
            <div className="relative">
              ...
              {usuario?.rol === 'superadmin' && (
                <span className="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-amber-400 rounded-full border-2 border-white flex items-center justify-center animate-pulse">
                    <svg className="w-1.5 h-1.5 sm:w-2 sm:h-2 text-amber-900" fill="currentColor" viewBox="0 0 24 24">
